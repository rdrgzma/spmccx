    ...
    <div class="page-body d-flex flex-column justify-content-center align-items-center ">
        <div class="col-md-6">
            ...
            <ul class="nav nav-tabs my-2" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="endereco-tab" data-bs-toggle="tab" data-bs-target="#endereco"
                        type="button" role="tab" aria-controls="endereco" aria-selected="false">Endereço</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="matricula-tab" data-bs-toggle="tab" data-bs-target="#matricula"
                        type="button" role="tab" aria-controls="matricula" aria-selected="false">Matrícula</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="dependente-tab" data-bs-toggle="tab" data-bs-target="#dependente"
                        type="button" role="tab" aria-controls="dependente" aria-selected="false">Dependentes</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="autorizacao-tab" data-bs-toggle="tab" data-bs-target="#autorizacao"
                        type="button" role="tab" aria-controls="settings" aria-selected="false">Autorização</button>
                </li>
            </ul>
            ...
            <div class="tab-content">
                        ...
                        <div class="form-group col-md-4 mb-3 ">
                            ...
                            <div>
                                <input type="date" class="form-control" aria-describedby="emailHelp"
                                    ...
                                    value="{{ old('data_associacao') }}" required>
                            </div>
                        </div>
                            ...
                            <div class="form-group mb-3 col-md-6">
                                ...
                                <div>
                                    <input type="text" class="form-control" placeholder="Cidade/Estado"
                                        name="naturalidade" value="{{ old('naturalidade') }}" required>
                                </div>
                ...
                <div class="tab-pane my-2" id="endereco" role="tabpanel" aria-labelledby="endereco-tab"
                    tabindex="0">
                    <div class="row">
                ...
                <div class="tab-pane my-2" id="matricula" role="tabpanel" aria-labelledby="matricula-tab"
                    tabindex="0">
                    <div class="row ">
                        <div class="form-group mb-3 col-6">
                            <label class="form-label">Matrícula Funcional</label>
                            <div>
                                <input type="text" class="form-control" placeholder="Matrícula Funcional"
                                    name="matricula">
                            </div>
                        </div>
                        <div class="form-group mb-3 col-6">
                    ...
                    <div class="row">
                        <div class="form-group col-4 mb-3 ">
                            ...
                            <div>
                                <input type="date" class="form-control" aria-describedby="emailHelp"
                                    placeholder="Data de Adimissão" name="data_admissao">
                            </div>
                        </div>
                        <div class="form-group mb-3 col-md-8">
                            ...
                            <div>
                                <label class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" checked="" name="turnos[]"
                                        value="Manhã">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 mb-3">
                            ...
                            <div>
                                <input type="text" class="form-control" placeholder="Cargo/Local de Trabalho"
                                    name="cargo">
                            </div>
                        </div>
                        <div class="form-group col-md-6 mb-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div>
                            ...
                            <div class="d-flex flex-row">
                                ...
                                <input type="text" class="form-control p-0" placeholder="Informe a área"
                                    name="area">
                            </div>
                        </div>
                    </div>
                    <div class="form-footer float-end">
                        <button type="submit" id="btn_matricula" class="btn btn-success">Salvar</button>
                    </div>
                </div>
                <div class="tab-pane my-2" id="dependente" role="tabpanel" aria-labelledby="dependente-tab"
                    tabindex="0">
                    <div class="form-group mb-3 ">
                        <label class="form-label">Nome Completo*</label>
                        <div>
                    ...
                    <div class="form-footer float-end">
                        <button type="submit" id="btn_dependente" class="btn btn-success">Salvar</button>
                    </div>
                </div>
                <div class="tab-pane my-2" id="autorizacao" role="tabpanel" aria-labelledby="autorizacao-tab"
                    tabindex="0">
